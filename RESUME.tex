...
\section{PROJECTS}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
            ...
            \resumeItem{Added a permanent block option for sites the user never wants to visit which runs at all times.}
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: Django, Flask, Bootstrap, React} \\
